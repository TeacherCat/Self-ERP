...
CREATE TABLE `hire` (
  ...
  `hire_opinion` VARCHAR(200) DEFAULT NULL,
  `hire_person` VARCHAR(50) NOT NULL,
...
CREATE TABLE `releases` (
  ...
  `rele_time` DATETIME NOT NULL,
  `rele_end_time` DATETIME NOT NULL,
  PRIMARY KEY (`rele_id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
CREATE TABLE `result` (
  ...
  `resu_result` VARCHAR(50) NOT NULL,
  `resu_opinion` VARCHAR(200) DEFAULT NULL,
  `resu_person` VARCHAR(50) NOT NULL,
  `resu_time` DATETIME NOT NULL,
  PRIMARY KEY (`resu_id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
CREATE TABLE `resumes` (
  ...
  `res_data` VARCHAR(200) DEFAULT NULL,
  `res_registrar` VARCHAR(50) NOT NULL,
