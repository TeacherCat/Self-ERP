				...
				<ul class="layui-nav admin-header-item">
					<li class="layui-nav-item">
						<a href="javascript:;" class="admin-header-user">
							<span style="color:#fff;">${sessionScope.users.role.name}：${sessionScope.users.realName}&nbsp;&nbsp;</span>
						</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="<%=request.getContextPath()%>/jsp/public/password.jsp"><i class="fa fa-sign-out" ></i> 修改密码</a>
							</dd>
							<dd>
								<a href="exit.do" onclick="return confirm('确认要退出系统吗？');">
