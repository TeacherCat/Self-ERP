...
<form id="myForm" action="addResumes.do" method="post">
	<div style="width:500px;margin:10px auto;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" maxlength="2" name="age">
			</div>
			<span class="msg">&nbsp;*&nbsp;</span>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" maxlength="11" name="telephone">
			</div>
			<span class="msg">&nbsp;*&nbsp;</span>
		</div>
		...
		<div class="layui-form-item">
			...
			<select class="select" name="releases.id">
				...
				<c:forEach var="releases" items="${releasesList}">
					<option value="${releases.id}">${releases.id}--${releases.post.name}</option>
				</c:forEach>
			</select>
			<span class="msg">&nbsp;*&nbsp;</span>
		</div>
