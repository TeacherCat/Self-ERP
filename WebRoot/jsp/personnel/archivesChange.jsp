...
<body>
<form id="myForm" action="changeArchives.do" method="post">
	<div class="layui-form-item" style="margin-top:20px;margin-right:20px;">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" maxlength="20" name="name" value="${archives.name}">
			</div>
			<span class="msg">&nbsp;*&nbsp;</span>
		</div>
		<div class="layui-inline">
		...
		<input type="submit" value="提&nbsp;&nbsp;交&nbsp;&nbsp;变&nbsp;&nbsp;更" class="layui-btn layui-btn-radius" style="margin-top:20px;margin-left:50px;"/>
