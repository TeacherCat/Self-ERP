		...
		<div class="layui-form-item" style="margin-top:20px;">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" maxlength="16" name="name" value="${users.name }">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label">真实姓名：</label>
				<div class="layui-input-inline">
					<input type="text" class="layui-input" maxlength="16" name="realName" value="${users.realName }">
				</div>
			</div>
			<div class="layui-inline">
