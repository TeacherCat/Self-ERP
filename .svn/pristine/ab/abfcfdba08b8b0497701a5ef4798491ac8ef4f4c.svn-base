...
<body>
	<div style="width:500px;margin:20px auto;">
		<form action="usersAdd.do" method="post" id="usersForm">
			
			<div class="layui-form-item">
				<label class="layui-form-label">用户名称：</label>
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="name" id="usersName" maxlength="16">
				</div>
				<span class="msg">&nbsp;*&nbsp;</span>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="realName" maxlength="12">
				</div>
				<span class="msg">&nbsp;*&nbsp;</span>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="password" class="layui-input" name="password" maxlength="16">
				</div>
				<span class="msg">&nbsp;*&nbsp;</span>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="password" class="layui-input" name="pwd" maxlength="16">
				</div>
				<span class="msg">&nbsp;*&nbsp;</span>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="telephone" maxlength="11">
				</div>
				<span class="msg">&nbsp;*&nbsp;</span>
			</div>
