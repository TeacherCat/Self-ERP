	...
	<div style="width:600px;margin:20px auto;">
		<form action="standardAdd.do" method="post" id="stanForm">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="amount" readonly="readonly" value="0.00">
				</div>
				<span class="msg">&nbsp;*&nbsp;</span>
			</div>
				...
				<table class="layui-table admin-table">
					...
					<c:forEach var="pro" items="${proList }">
						<tr>
							<td>${pro.id}</td>
							<td>${pro.name}</td>
							<td><input type="text" class="layui-input" name="money" value="0.00" onchange="totalPrice()"></td>
						</tr>
					</c:forEach>
				</table>
			</div>
