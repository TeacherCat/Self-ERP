...
<form id="myForm" action="updReleases.do" method="post">
	<div class="layui-form-item" style="margin-top:20px;margin-right:20px;">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" name="limit" maxlength="4" value="${releases.limit}">
			</div>
			<span class="msg">&nbsp;*&nbsp;</span>
		</div><br/><br/>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea style="width:600px;" class="layui-textarea" name="desc" maxlength="50">${releases.desc}</textarea>
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea style="width:600px;" class="layui-textarea" name="requier" maxlength="50">${releases.requier}</textarea>
			</div>
		</div>
